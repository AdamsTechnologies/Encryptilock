...
//     final masked = _passwordController.text.trim() == '••••••••••';
//     final controllerText = _passwordController.text.trim();
//     final passwordToSave = _passwordChanged
//         ? _decryptedPassword ?? controllerText
//         : masked
//             ? widget.existingRecord['password']
//             : controllerText;
...
//     await context.read<PasswordProvider>().addOrUpdatePassword(updatedData, passwordChanged: _passwordChanged);
//     widget.onSaveComplete?.call(updatedData['id']);
//   }
...
//                 Text('Edit Password', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
//                 const SizedBox(height: 20),
//                 _buildTextField('Title', _serviceController),
//                 _buildTextField('Username', _usernameController),
//                 _isDecrypting ? const CircularProgressIndicator() : _buildPasswordField(),
//                 _buildTextField('Category', _serviceTypeController),
